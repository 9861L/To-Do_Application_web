...
//    @Test
//    void getToDoByArchiveStatusForFailure() throws Exception  {
//        when(todoService.getToDoListByArchivedStatus(user1.getEmailId(), todo1.isCompleted())).thenThrow(ToDoNotFoundException.class);
//
//        mockMvc.perform(get("/toDo/user/getAllToDoByArchiveStatus/")
//                        .requestAttr("emailId", user1.getEmailId()))
//                .andExpect(status().isNotFound())
//                .andDo(MockMvcResultHandlers.print());
//        verify(todoService, times(0)).getToDoListByArchivedStatus(any(), any());
//    }
